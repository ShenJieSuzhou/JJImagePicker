...
typedef NS_ENUM(NSUInteger, JJButtonStyle){
    JJButtonImageLeft = 0,    //图片在左
    JJSButtonImageRight = 1,  //图片在右
    JJButtonImageTop = 2,     //图片在上
    JJButtonImageBottom = 3,  //图片在下
};
 ...
 */
@property (nonatomic, assign) JJButtonStyle buttonStyle;
